...
from .views import (
    ...
    CoachClientNoteView,
    CoachClientArchiveView,
    CoachClientUnarchiveView,
...
urlpatterns = [
    ...
    path("coach/clients/<uuid:client_id>/archive/", CoachClientArchiveView.as_view(), name="coach-client-archive"),
    path("coach/clients/<uuid:client_id>/unarchive/", CoachClientUnarchiveView.as_view(), name="coach-client-unarchive"),
    path("coach/clients/<uuid:client_id>/tasks/", CoachClientTaskCreateView.as_view(), name="coach-client-task-create"),
